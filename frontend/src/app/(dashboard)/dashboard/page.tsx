...
function DashboardPageContent() {
  ...
  const activeStreaks = habits.length; // Placeholder - will be replaced with real stats
    ...
    <ProtectedRoute>
      <div className="min-h-screen bg-background p-4 sm:p-6 lg:p-8">
        <div className="max-w-7xl mx-auto">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  {habits.length === 0 ? 'No habits yet' : 'Active habits'}
                </p>
              </CardContent>
            </Card>
          ...
          {habits.length > 0 && (
            <div>
              <h2 className="text-xl sm:text-2xl font-semibold mb-4">Recent Habits</h2>
